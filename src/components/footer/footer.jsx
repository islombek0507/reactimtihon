...
<nav className="footer__nav">
    ...
    <li className="footer__item">
        <Link to="#"  className="footer__link">Figma</Link>
        </li>
</ul>
    </div>
    <div className="footer__div">
        <h3 className="white">WHAT I HAVE DONE:</h3>
    <ul className="footer__list">
<li className="footer__item">
        <Link to="#" className="footer__link">Xalq Kutubxonasi</Link>
        </li>
    <li className="footer__item">
        <Link to="#" className="footer__link footer__link--active">Websitee</Link>
        </li>
    <li className="footer__item">
        <Link to="#" className="footer__link">Website</Link>
        </li>
    <li className="footer__item">
        <Link to="#" className="footer__link">Play Market</Link>
        </li>
    <li className="footer__item">
        <Link to="#" className="footer__link">App Store</Link>
        </li>
</ul>
    </div>
    <div className="footer__div">
...
<li className="footer__item">
    ...
    <li className="footer__item">
        <Link to="#" className="footer__link footer__link--active">Blog</Link>
        </li>
    <li className="footer__item">
        <Link to="#" className="footer__link">Dribbble</Link>
        </li>
    <li className="footer__item">
